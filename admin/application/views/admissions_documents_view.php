                                            ...
                                            <div class="card-block">
                                                <div class="row">
                                                    <div class="profile-avatar" id="photo-view">
                                                        <img width="200" id="photo-img" src="<?php echo $student_photo; ?>" alt="">
                                                    </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="box-block bg-white">
                                    ...
                                    <div class="upload-signature-block text-xs-center">
                                        <img src="<?php echo $signature; ?>" id="signature-img" width="200" <?php if (!$signature) { ?>style="display: none;<?php } ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <div class="box-block bg-white">
                                    <div class="card-block">
                                        <div class="row">
                                            <div class="profile-avatar" id="dvPreview-id-proof">
                                                <img width="200" id="document-img" src="<?php echo $id_proof; ?>" alt="">
                                            </div>
                                    ...
                                    <div class="modal-footer">
                                        <form method="post" id="addFrm">
                                            ...
                                            <button type="submit" id="ca" class="btn btn-primary">Confirm Admission</button>
                                        </form>
                                        <br>
        ...
        <script type="text/javascript">
            ...
            $(function () {
                ...
                $("#addFrm").on("submit", function (event) {
                    event.preventDefault();
                    $("#ca").val("Please Wait...").attr('disabled', true);
                    loaderProcess();
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (obj.status.error) {
                                loaderFail(obj.status.message);
                                $("#ca").val("Please Wait...").attr('disabled', false);
                                return false;
                            }
                            loaderSuccess();
            ...
            function savePngFile(base64) {
                $('.loader_2').addClass('loader');
                $.ajax({
                    url: site_url + 'admissions/base64_to_png',
                    type: "post",
                    data: {name: base64},
                    success: function (data) {
                        var obj = $.parseJSON(data);
                        ...
                        loaderSuccess();
                        $('.loader_2').removeClass('loader');

                        $("#signature-img").show();
                        $("#signature-img").attr("src", obj.payload.upload.file_url);
                        $('#h-signature_id').val(obj.payload.upload.id);
                        $('#error_signature').hide();
                    }
                });
            }
        </script>
