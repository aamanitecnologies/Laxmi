                            ...
                            <div class="col-sm-4 col-md-3">
                                ...
                                <div class="card profile-card">
                                    <div class="card-block">
                                        <h4 class="mb-0-25"><?php echo $batch->payload->batch->batch_code; ?> <span class="text-muted" style="font-size: 10px; padding: 0 0 0 10px;"><?php echo dateFromat($batch->payload->batch->batch_start_date); ?></span><span title="edit" class="edit-profile" style="cursor: pointer; float: right; font-size: 14px; color:#aaa; padding:4px 0 0 0;"><i class="ti-pencil"></i></span></h4>
